      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="/vegekit/main">Home</a></span> <span>Checkout</span></p>
	          ...
	          <div class="row mt-5 pt-3">
	          	<div class="col-md-12 d-flex mb-5">
	          		<div class="cart-detail cart-total p-3 p-md-4">
	          			<h1 class="billing-heading mb-4">구독 결제 성공</h1>
	          			<p class="d-flex">
    						<span>주문 번호</span>
    						<span>${onum}</span>
    					</p>
    					...
    					<p class="d-flex">
							<a href="/vegekit/main" id="mainBtn">메인으로</a>
						</p>
						<p class="d-flex">
							<a href="/vegekit/shop/list" id="listBtn">쇼핑 계속하기</a>
						</p>
					</div>
	          	</div>
	          </div>
